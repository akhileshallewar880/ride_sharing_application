        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KycDocUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ScheduleTemplates_Routes_RouteId",
                        column: x => x.RouteId,
                        principalTable: "Routes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RideInstances", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RideInstances_ScheduleTemplates_ScheduleTemplateId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RideInstanceId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bookings_RideInstances_RideInstanceId",
                        column: x => x.RideInstanceId,
                        principalTable: "RideInstances",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bookings_Users_PassengerUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_RideInstanceId",
                table: "Bookings",
                column: "RideInstanceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RideInstances_ScheduleTemplateId",
                table: "RideInstances",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScheduleTemplates_RouteId",
